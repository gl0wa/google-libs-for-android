...
public final class Loadable implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public Loadable(LoaderManager loaderManager, int loaderId, LoaderCallbacks<Cursor> callbacks) {
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        return appendQueryParameters((CursorLoader) mCallbacks.onCreateLoader(id, args), args);
    }
