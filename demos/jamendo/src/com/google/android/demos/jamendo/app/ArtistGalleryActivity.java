...
public class ArtistGalleryActivity extends Activity implements AdapterView.OnItemClickListener {

    private static final int QUERY_ARTISTS = 1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new ArtistGalleryAdapter(this, QUERY_ARTISTS);
